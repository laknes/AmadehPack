...
در مرحله تنظیم دیتابیس، اسکریپت مستقیماً `DATABASE_URL` را از شما درخواست می‌کند و مقدار آن را از متغیر محیطی یا فایل دیگری نمی‌خواند. URL باید با `postgresql://` یا `postgres://` شروع شود. SSL اختیاری است و به‌صورت پیش‌فرض فعال نمی‌شود.
