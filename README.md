...
در حالت نصب خودکار، اسکریپت بدون دریافت ورودی از کاربر از PostgreSQL محلی با مقدار `postgresql://postgres:postgres@127.0.0.1:5432/amadeh_pack?schema=public` استفاده می‌کند. SSL نیز اختیاری است و به‌صورت پیش‌فرض فعال نمی‌شود.
