  ...
  return (
    <section className="container section">
      <div className="max-w-3xl">
        <p className="text-[#B8874B]">درباره کرافت پک</p>
        <h1 className="mt-2 text-4xl font-black">زیرساخت تامین بسته‌بندی برای برندهای غذایی</h1>
        <p className="mt-6 leading-9 text-[#6F6256]">کرافت پک با تمرکز بر ظروف کاغذی، کرافت، کارتن پیتزا و ملزومات سرو غذا، تجربه خریدی سریع و شفاف برای سفارش‌های خرده و عمده فراهم می‌کند.</p>
      </div>
